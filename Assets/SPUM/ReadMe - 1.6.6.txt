...
-----------------
1.6.6
- animation for sample scene error is fixed.
- save unit position error is fixed.
...
- Bug fixed 
  ...
  3) Sprite Sheet - Fixed an issue where ability animations could not be exported.
