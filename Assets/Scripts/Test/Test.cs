...
public class Test : MonoBehaviour {
    ...
    private IEnumerator Co_Init(object data) {
        ...
        var das = Managers.Data.DecryptionLoadJson<Define>("TestDefine");
    ...
    private async void GetDataKey() {
        Managers.Data.Key = (string)await Managers.FireStore.LoadDataToFireStore(Managers.Data.DefineData.TAG_KEY_DATA, Managers.Data.DefineData.TAG_KEY_DOCUMENT, Managers.Data.DefineData.TAG_DATA_KEY);
    }
}